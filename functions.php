...
if ($argon_assets_path== "jsdelivr"){
	$GLOBALS['assets_path'] = "https://cdn.jsdelivr.net/gh/moeYuiYui/argon-theme@" . wp_get_theme() -> Version;
}else if ($argon_assets_path == "fastgit"){
	$GLOBALS['assets_path'] = "https://raw.fastgit.org/moeYuiYui/argon-theme/v" . wp_get_theme() -> Version;
}else{
...
if ($argon_update_source == 'stop'){
		...
		'https://raw.githubusercontent.com/moeYuiYui/argon-theme/master/info.json',
...
window.pjaxLoaded = function(){
	...
	//do something...
					...
					<tr><th class="subtitle"><h2><?php _e('邮件功能', 'argon');?></h2></th></tr>
					<tr>
						<th><label><?php _e('是否开启邮件功能', 'argon');?></label></th>
						<td>
							<select name="argon_enable_mail">
								<?php $argon_enable_mail = get_option('argon_enable_mail'); ?>
								<option value="false" <?php if ($argon_enable_mail=='false'){echo 'selected';} ?>><?php _e('否', 'argon');?></option>
								<option value="true" <?php if ($argon_enable_mail=='true'){echo 'selected';} ?>><?php _e('是', 'argon');?></option>
							</select>
							<p class="description"></p>
						</td>
					</tr>
					<tr>
					    <th><label><?php _e('发件人', 'argon');?></label></th>
						
						<td>
							<input type="text" class="regular-text" name="argon_mail_name" value="<?php echo get_option('argon_mail_name'); ?>"/>
						</td>
					</tr>
					<tr>
						<th><label><?php _e('邮件服务器', 'argon');?></label></th>
						<td>
							<input type="text" class="regular-text" name="argon_mail_host" value="<?php echo get_option('argon_mail_host'); ?>"/>
						</td>
					</tr>
					<tr>
						<th><label><?php _e('服务器端口', 'argon');?></label></th>
						<td>
							<input type="text" class="regular-text" name="argon_mail_port" value="<?php echo get_option('argon_mail_port'); ?>"/>
						</td>
					</tr>
					<tr>
						<th><label><?php _e('邮箱帐号', 'argon');?></label></th>
						<td>
							<input type="text" class="regular-text" name="argon_mail_username" value="<?php echo get_option('argon_mail_username'); ?>"/>
						</td>
					</tr>
					<tr>
					...
					<tr>
					    <th><label><?php _e('是否开启SMTPSecure', 'argon');?></label></th>
						<td>
							<select name="argon_enable_mail_smtpauth">
								<?php $argon_enable_mail_smtpauth = get_option('argon_enable_mail_smtpauth'); ?>
								<option value="false" <?php if ($argon_enable_mail_smtpauth=='false'){echo 'selected';} ?>><?php _e('否', 'argon');?></option>
								<option value="true" <?php if ($argon_enable_mail_smtpauth=='true'){echo 'selected';} ?>><?php _e('是', 'argon');?></option>
							</select>
							<p class="description"></p>
						</td>
					</tr>
					<tr>
						<th><label><?php _e('SMTPSecure设置', 'argon');?></label></th>
						<td>
							<input type="text" class="regular-text" name="argon_mail_auth" value="<?php echo get_option('argon_mail_auth'); ?>"/>
							<p class="description"><?php _e('若启用SMTPAuth服务则填写ssl，若不启用则留空；office365的邮箱请填写STARTTLS', 'argon');?></p>
						</td>
					</tr>
					<tr><th class="subtitle"><h2><?php _e('APlayer', 'argon');?></h2></th></tr>
					<tr>
					    <th><label><?php _e('是否开启APlayer音乐播放器', 'argon');?></label></th>
						<td>
							<select name="argon_aplayer">
								<?php $argon_aplayer = get_option('argon_aplayer'); ?>
								<option value="false" <?php if ($argon_aplayer=='false'){echo 'selected';} ?>><?php _e('否', 'argon');?></option>
								<option value="true" <?php if ($argon_aplayer=='true'){echo 'selected';} ?>><?php _e('是', 'argon');?></option>
							</select>
							<p class="description"></p>
						</td>
					</tr>
					<tr>
						<th><label><?php _e('APlayer JSON播放列表地址', 'argon');?></label></th>
						<td>
							<input type="text" class="regular-text" name="argon_aplayer_playlist" value="<?php echo get_option('argon_aplayer_playlist'); ?>"/>
							<p class="description"><?php _e('借助API解析网易云，比如：https://api.yui.one/music/?server=netease&type=artist&id=159692 或者输入其他json地址', 'argon');?></p>
						</td>
					</tr>
					<tr>
					    <th><label><?php _e('是否开启APlayer自动播放', 'argon');?></label></th>
						<td>
							<select name="argon_aplayer_auto">
								<?php $argon_aplayer_auto = get_option('argon_aplayer_auto'); ?>
								<option value="false" <?php if ($argon_aplayer_auto=='false'){echo 'selected';} ?>><?php _e('否', 'argon');?></option>
								<option value="true" <?php if ($argon_aplayer_auto=='true'){echo 'selected';} ?>><?php _e('是', 'argon');?></option>
							</select>
							<p class="description"></p>
						</td>
					</tr>
					<tr>
					    <th><label><?php _e('是否开启APlayer循环播放', 'argon');?></label></th>
						<td>
							<select name="argon_aplayer_loop">
								<?php $argon_aplayer_loop = get_option('argon_aplayer_loop'); ?>
								<option value="false" <?php if ($argon_aplayer_loop=='false'){echo 'selected';} ?>><?php _e('否', 'argon');?></option>
								<option value="true" <?php if ($argon_aplayer_loop=='true'){echo 'selected';} ?>><?php _e('是', 'argon');?></option>
							</select>
							<p class="description"></p>
						</td>
					</tr>
					<tr>
					    <th><label><?php _e('播放顺序', 'argon');?></label></th>
						<td>
							<select name="argon_aplayer_order">
								<?php $argon_aplayer_order = get_option('argon_aplayer_order'); ?>
								<option value="list" <?php if ($argon_aplayer_order=='list'){echo 'selected';} ?>><?php _e('列表', 'argon');?></option>
								<option value="random" <?php if ($argon_aplayer_order=='random'){echo 'selected';} ?>><?php _e('随机', 'argon');?></option>
							</select>
							<p class="description"></p>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							...
							<p class="description"><?php _e('页脚最下方显示建站日期，需与下方建站时间同时设置，有一个留空则不显示。格式为MM/dd/yyyy（月/日/年）', 'argon');?></p>
						</td>
					</tr>
					<tr>
						<th><label><?php _e('建站时间', 'argon');?></label></th>
						<td>
							<input type="text" class="regular-text" name="argon_build_time" value="<?php echo get_option('argon_build_time'); ?>"/>
							<p class="description"><?php _e('页脚最下方显示建站时间，需与上方建站日期同时设置，有一个留空则不显示。格式为HH:mm:ss（时/分/秒）', 'argon');?></p>
						</td>
					</tr>
					<tr>
...
function argon_update_themeoptions(){
	...
	if ($_POST['update_themeoptions'] == 'true'){
		...
		//邮件功能与建站时间
		argon_update_option('argon_build_date');
		argon_update_option('argon_build_time');
		argon_update_option('argon_enable_mail');
		argon_update_option('argon_mail_name');
		argon_update_option('argon_mail_host');
		argon_update_option('argon_mail_port');
		argon_update_option('argon_mail_username');
		argon_update_option('argon_mail_password');
		argon_update_option('argon_enable_mail_smtpauth');
		argon_update_option('argon_mail_auth');
		argon_update_option('argon_aplayer');
		argon_update_option('argon_aplayer_auto');
		argon_update_option('argon_aplayer_loop');
		argon_update_option('argon_aplayer_order');
		argon_update_option_allow_tags('argon_aplayer_playlist');
	}
}
...
function mail_smtp($phpmailer){
    if(get_option('argon_enable_mail')== 'true'){
        $mail_name = get_option('argon_mail_name');
        $mail_host = get_option('argon_mail_host');
        $mail_port = get_option('argon_mail_port');
        $mail_username = get_option('argon_mail_username');
        $mail_passwd = get_option('argon_mail_password');
        $mail_smtpsecure = get_option('argon_mail_auth');
        $phpmailer->FromName = $mail_name?$mail_name:'Argon Services Team'; 
        $phpmailer->Host = $mail_host?$mail_host:'smtp.argon.com';
        $phpmailer->Port = $mail_port?$mail_port:'465';
        $phpmailer->Username = $mail_username?$mail_username:'no_reply@argon.com';
        $phpmailer->Password = $mail_passwd?$mail_passwd:'123456789';
        $phpmailer->From = $mail_username?$mail_username:'no_reply@argon.com';
        $phpmailer->SMTPAuth = get_option('argon_enable_mail_smtpauth')== 'true'?true:false ;
